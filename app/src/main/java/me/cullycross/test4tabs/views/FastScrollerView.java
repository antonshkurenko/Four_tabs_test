...
public class FastScrollerView extends LinearLayout {
  ...
  public FastScrollerView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init(context);
  }

  public FastScrollerView(final Context context) {
    super(context);
    init(context);
  }

  public FastScrollerView(final Context context, final AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }
  ...
  private void setRecyclerViewPosition(float y) {
    if (recyclerView != null) {
      ...
      ((LinearLayoutManager) recyclerView.getLayoutManager()).scrollToPositionWithOffset(targetPos,
          0);
      final String bubbleText =
          ((BubbleTextGetter) recyclerView.getAdapter()).getTextToShowInBubble(targetPos);
      if (bubble != null) bubble.setText(bubbleText);
    }
  }
